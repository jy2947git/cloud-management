...
class Ec2StatusReporter(StatusReporter):
    ...
    def collect(self):
        ...
        msg = json.dumps({"name":instanceId, "private_name":localName,"public_name":publicName, "private_ip":privateIp,"public_ip":publicIp, "user_data":userData},sort_keys=True)
        return msg
