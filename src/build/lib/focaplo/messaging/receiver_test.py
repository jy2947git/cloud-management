...
class Test(unittest.TestCase):
    ...
    def testListenerOfHaproxy(self):
        listener = focaplo.messaging.haproxy_listener.HaproxyListener()
        listener.listen("192.168.8.130", "5672", "guest", "guest", "/", "haproxy","incoming", "configuration", listener.callback_reconfigure_haproxy)
    ...
    def testStartHaproxyListener(self):
        listener = focaplo.messaging.haproxy_listener.HaproxyListener()
        listener.startHaproxyListener("192.168.8.130", "5672", "guest", "guest")
...
if __name__ == "__main__":
    print 'test main'
    import sys;sys.argv = ['', 'Test.testStartHaproxyListener']
    unittest.main()